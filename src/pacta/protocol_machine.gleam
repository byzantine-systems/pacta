//// Drives a session-typed protocol (see `pacta/session/core`) from a
...
////
//// Like `pacta/session/core`, it performs no I/O. `transmit` checks a
...
///
/// `pacta/protocol/emit` writes protocols that repeat as flat named
